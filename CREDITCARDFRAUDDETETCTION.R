# using supervised learning algorithm - data labelling - unbalanced data
...
#importing dataset from respective folder
#Time
#v1.......v29-it is reduced version (using dimensionality reduction)of actual dataset..PCA..confedentiality of uer is maintained
#amount:amount of transaction that was done by particular column
#class two value 0,1
...
# we find the k nearest neighors of a fraud case suppose X
